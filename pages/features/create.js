    ...
    >
      ...
      >
        ...
        <FormControl
          ...
          maxW="3xl"
          mt={10}
          isInvalid={errors.problem?.message?.length > 0}
        >
          ...
          {errors.problem?.message ? (
            <FormErrorMessage>{errors.problem?.message}</FormErrorMessage>
          ) : (
            <FormHelperText>
        ...
        <FormControl
          ...
          maxW="3xl"
          mt={10}
          isInvalid={errors.impact?.message?.length > 0}
        >
          ...
          <Textarea
            ...
            id="impact"
            placeholder={
              "User's without a Google account can not sign in to the platform..."
            }
            name="impact"
            ref={register}
          />
          ...
          {errors.impact?.message ? (
            <FormErrorMessage>{errors.impact?.message}</FormErrorMessage>
          ) : (
            <FormHelperText>
        ...
        <FormControl
          ...
          maxW="3xl"
          mt={10}
          isInvalid={errors.cost?.message?.length > 0}
        >
          ...
          <Textarea
            ...
            id="cost"
            placeholder={
              "We loose 100s of potential customers who only have a Google account"
            }
            name="cost"
            ref={register}
          />
        ...
        <FormControl
          ...
          maxW="3xl"
          mt={10}
          isInvalid={errors.goal?.message?.length > 0}
        >
        ...
        <FormControl
          ...
          maxW="3xl"
          mt={10}
          isInvalid={errors.need?.message?.length > 0}
        >
        ...
        <FormControl
          ...
          maxW="3xl"
          mt={10}
          isInvalid={errors.solution?.message?.length > 0}
        >
