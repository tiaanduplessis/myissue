...
const faqs = [
  ...
  },
  {
    ...
    text:
      "It's free to create a bug. You can also sign up and use the rest of the platform for free. Some additional priced features may be added in the future.",
  },

  {
    title: "Can it integrate with my project management software?",
    text: "Additional integrations are planned for the future.",
  },
  {
    title:
      "It feels limited. Can I do additional configuration for my use case?",
    text:
      "Things are kept as simple as possible to make it easy for non-technical users to get things done. Additioanl configuration features may be added in the future, but not at cost of complexity.",
  },
]
